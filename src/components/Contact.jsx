...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="py-6 bg-gradient-to-br from-blue-600 to-purple-700 relative z-10"
    >
      <div
        ref={ref}
        className={`max-w-6xl mx-auto px-6 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
          } transition-all duration-700`}
      >
        <div className="text-center mb-6">
          <h2 className="text-3xl font-bold text-white mb-2 transform hover:scale-105 transition-transform duration-300">
            Let's Work Together
          </h2>
