...
export default function HeroDesktopContent() {
  return (
    <div className="-ml-2">
      ...
      <div className="flex items-center gap-2 mb-4 transition-all duration-40 delay-20 opacity-100 translate-y-0">
      ...
      <p className="text-stone-500 text-sm md:text-base leading-relaxed max-w-lg mb-7 transition-all duration-500 delay-200 opacity-100 translate-y-0">
        Passionate full-stack developer building AI-integrated web applications with React, Next.js, Node.js, and MongoDB. I turn complex real-world problems into clean, scalable digital solutions.
      </p>
