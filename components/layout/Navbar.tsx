    ...
    <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-400 bg-white/60 backdrop-blur-md py-5">
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <button suppressHydrationWarning className="cursor-pointer flex items-center gap-1.5 px-5 py-2 text-[13px] font-semibold text-white bg-[#1a1a1a] rounded-lg hover:bg-[#a07850] transition-all duration-300 whitespace-nowrap">
      ...
      >
        <div className="bg-white border-t border-stone-100 px-6 py-4 flex flex-col gap-1">
          ...
          <div className="flex gap-3 mt-3 pt-3 border-t border-stone-100">
            ...
            <button suppressHydrationWarning className="cursor-pointer flex-1 py-2.5 text-sm font-semibold text-white bg-[#1a1a1a] rounded-xl whitespace-nowrap">
              Hire Me
            </button>
          </div>
        </div>
